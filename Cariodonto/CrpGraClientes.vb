...
Public Class CrpGraClientes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cariodonto.CrpGraClientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpGraClientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpGraClientes = New CrpGraClientes
        rpt.Site = Me.Site
        Return rpt
    End Function
