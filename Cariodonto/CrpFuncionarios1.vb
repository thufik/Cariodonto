...
Public Class CrpFuncionarios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cariodonto.CrpFuncionarios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpFuncionarios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpFuncionarios = New CrpFuncionarios
        rpt.Site = Me.Site
        Return rpt
    End Function
