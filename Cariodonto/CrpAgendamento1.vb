...
Public Class CrpAgendamento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cariodonto.CrpAgendamento.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpAgendamento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpAgendamento = New CrpAgendamento
        rpt.Site = Me.Site
        Return rpt
    End Function
