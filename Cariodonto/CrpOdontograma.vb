...
Public Class CrpOdontograma
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cariodonto.CrpOdontograma.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpOdontograma
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpOdontograma = New CrpOdontograma
        rpt.Site = Me.Site
        Return rpt
    End Function
