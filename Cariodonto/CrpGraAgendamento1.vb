...
Public Class CrpGraAgendamento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cariodonto.CrpGraAgendamento.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpGraAgendamento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpGraAgendamento = New CrpGraAgendamento
        rpt.Site = Me.Site
        Return rpt
    End Function
