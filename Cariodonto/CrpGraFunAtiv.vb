...
Public Class CrpGraFunAtiv
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cariodonto.CrpGraFunAtiv.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpGraFunAtiv
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpGraFunAtiv = New CrpGraFunAtiv
        rpt.Site = Me.Site
        Return rpt
    End Function
