...
Public Class CrpReceituario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cariodonto.CrpReceituario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpReceituario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpReceituario = New CrpReceituario
        rpt.Site = Me.Site
        Return rpt
    End Function
